...
if __name__ == "__main__":
  ...
  parser.add_argument('--results-per-iteration', type=int, default=5000, help='passed to arxiv API')
  ...
  if num_added_total > 0:
    print('Saving database with %d papers to %s' % (len(db), 'papers.p'))
    handle = open('papers.p', 'wb')
